...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'PurpleRobotReading', fields ['probe', 'user_id']
        db.create_index(u'purple_robot_app_purplerobotreading', ['probe', 'user_id'])


    def backwards(self, orm):
        # Removing index on 'PurpleRobotReading', fields ['probe', 'user_id']
        db.delete_index(u'purple_robot_app_purplerobotreading', ['probe', 'user_id'])
    ...
    models = {
        ...
        u'purple_robot_app.purplerobotreading': {
            'Meta': {'object_name': 'PurpleRobotReading', 'index_together': "[['probe', 'user_id']]"},
