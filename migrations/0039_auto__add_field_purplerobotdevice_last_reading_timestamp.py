...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurpleRobotDevice.last_reading_timestamp'
        db.add_column(u'purple_robot_app_purplerobotdevice', 'last_reading_timestamp',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurpleRobotDevice.last_reading_timestamp'
        db.delete_column(u'purple_robot_app_purplerobotdevice', 'last_reading_timestamp')
