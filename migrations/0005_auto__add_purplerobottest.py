...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PurpleRobotTest'
        db.create_table(u'purple_robot_app_purplerobottest', (
            ...
            ('timestamps', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'purple_robot_app', ['PurpleRobotTest'])


    def backwards(self, orm):
        # Deleting model 'PurpleRobotTest'
        db.delete_table(u'purple_robot_app_purplerobottest')
    ...
    models = {
        ...
        u'purple_robot_app.purplerobottest': {
            ...
            'timestamps': ('django.db.models.fields.TextField', [], {}),
            'user_id': ('django.db.models.fields.CharField', [], {'max_length': '1024'})
        }
    }
