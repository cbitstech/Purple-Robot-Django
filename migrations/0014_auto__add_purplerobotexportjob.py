...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PurpleRobotExportJob'
        db.create_table(u'purple_robot_app_purplerobotexportjob', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('probes', self.gf('django.db.models.fields.TextField')(max_length=8196, null=True, blank=True)),
            ('users', self.gf('django.db.models.fields.TextField')(max_length=8196, null=True, blank=True)),
            ('start_date', self.gf('django.db.models.fields.DateField')()),
            ('end_date', self.gf('django.db.models.fields.DateField')()),
            ('export_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, blank=True)),
            ('destination', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ('state', self.gf('django.db.models.fields.CharField')(default='pending', max_length=512)),
        ))
        db.send_create_signal(u'purple_robot_app', ['PurpleRobotExportJob'])


    def backwards(self, orm):
        # Deleting model 'PurpleRobotExportJob'
        db.delete_table(u'purple_robot_app_purplerobotexportjob')
