...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurpleRobotDevice.mute_alerts'
        db.add_column(u'purple_robot_app_purplerobotdevice', 'mute_alerts',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurpleRobotDevice.mute_alerts'
        db.delete_column(u'purple_robot_app_purplerobotdevice', 'mute_alerts')
