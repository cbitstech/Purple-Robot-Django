...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'PurpleRobotReading', fields ['logged']
        db.create_index(u'purple_robot_app_purplerobotreading', ['logged'])


    def backwards(self, orm):
        # Removing index on 'PurpleRobotReading', fields ['logged']
        db.delete_index(u'purple_robot_app_purplerobotreading', ['logged'])
