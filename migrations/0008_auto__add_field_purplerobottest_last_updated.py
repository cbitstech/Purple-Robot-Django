...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurpleRobotTest.last_updated'
        db.add_column(u'purple_robot_app_purplerobottest', 'last_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 12, 19, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurpleRobotTest.last_updated'
        db.delete_column(u'purple_robot_app_purplerobottest', 'last_updated')
