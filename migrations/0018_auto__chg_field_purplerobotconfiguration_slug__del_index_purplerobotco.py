...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PurpleRobotConfiguration.slug'
        db.alter_column(u'purple_robot_app_purplerobotconfiguration', 'slug', self.gf('django.db.models.fields.CharField')(unique=True, max_length=1024))
        # Removing index on 'PurpleRobotConfiguration', fields ['slug']
        # db.delete_index(u'purple_robot_app_purplerobotconfiguration', ['slug'])


    def backwards(self, orm):
        # Adding index on 'PurpleRobotConfiguration', fields ['slug']
        db.create_index(u'purple_robot_app_purplerobotconfiguration', ['slug'])


        # Changing field 'PurpleRobotConfiguration.slug'
        db.alter_column(u'purple_robot_app_purplerobotconfiguration', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=1024, unique=True))
