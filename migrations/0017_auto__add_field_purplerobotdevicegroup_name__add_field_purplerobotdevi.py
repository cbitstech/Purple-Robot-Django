...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurpleRobotDeviceGroup.name'
        db.add_column(u'purple_robot_app_purplerobotdevicegroup', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024),
                      keep_default=False)

        # Adding field 'PurpleRobotDevice.name'
        db.add_column(u'purple_robot_app_purplerobotdevice', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurpleRobotDeviceGroup.name'
        db.delete_column(u'purple_robot_app_purplerobotdevicegroup', 'name')

        # Deleting field 'PurpleRobotDevice.name'
        db.delete_column(u'purple_robot_app_purplerobotdevice', 'name')
