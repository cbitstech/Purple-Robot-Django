...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'purple_robot_app_purplerobotconfiguration', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=1024))

    def backwards(self, orm):

        # Changing field 'PurpleRobotConfiguration.slug'
        db.alter_column(u'purple_robot_app_purplerobotconfiguration', 'slug', self.gf('django.db.models.fields.CharField')(max_length=1024, unique=True))
