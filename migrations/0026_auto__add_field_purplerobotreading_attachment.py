...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurpleRobotReading.attachment'
        db.add_column(u'purple_robot_app_purplerobotreading', 'attachment',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurpleRobotReading.attachment'
        db.delete_column(u'purple_robot_app_purplerobotreading', 'attachment')
