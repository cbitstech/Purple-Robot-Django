...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurpleRobotDeviceGroup.description'
        db.add_column(u'purple_robot_app_purplerobotdevicegroup', 'description',
                      self.gf('django.db.models.fields.TextField')(max_length=1048576, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PurpleRobotDeviceGroup.configuration'
        db.add_column(u'purple_robot_app_purplerobotdevicegroup', 'configuration',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='groups', null=True, to=orm['purple_robot_app.PurpleRobotConfiguration']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurpleRobotDeviceGroup.description'
        db.delete_column(u'purple_robot_app_purplerobotdevicegroup', 'description')

        # Deleting field 'PurpleRobotDeviceGroup.configuration'
        db.delete_column(u'purple_robot_app_purplerobotdevicegroup', 'configuration_id')
