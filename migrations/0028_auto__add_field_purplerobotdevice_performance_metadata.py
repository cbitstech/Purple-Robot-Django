...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurpleRobotDevice.performance_metadata'
        db.add_column(u'purple_robot_app_purplerobotdevice', 'performance_metadata',
                      self.gf('django.db.models.fields.TextField')(default='{}', max_length=1048576),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurpleRobotDevice.performance_metadata'
        db.delete_column(u'purple_robot_app_purplerobotdevice', 'performance_metadata')
