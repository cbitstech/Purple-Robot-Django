...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurpleRobotEvent.name'
        db.add_column(u'purple_robot_app_purplerobotevent', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurpleRobotEvent.name'
        db.delete_column(u'purple_robot_app_purplerobotevent', 'name')
