...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'PurpleRobotEvent', fields ['logged']
        db.create_index(u'purple_robot_app_purplerobotevent', ['logged'])


    def backwards(self, orm):
        # Removing index on 'PurpleRobotEvent', fields ['logged']
        db.delete_index(u'purple_robot_app_purplerobotevent', ['logged'])
