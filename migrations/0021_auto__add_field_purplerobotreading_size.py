...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurpleRobotReading.size'
        db.add_column(u'purple_robot_app_purplerobotreading', 'size',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurpleRobotReading.size'
        db.delete_column(u'purple_robot_app_purplerobotreading', 'size')
