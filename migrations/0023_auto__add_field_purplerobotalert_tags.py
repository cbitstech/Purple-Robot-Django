...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurpleRobotAlert.tags'
        db.add_column(u'purple_robot_app_purplerobotalert', 'tags',
                      self.gf('django.db.models.fields.CharField')(max_length=2048, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurpleRobotAlert.tags'
        db.delete_column(u'purple_robot_app_purplerobotalert', 'tags')
