...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'PurpleRobotReading', fields ['size']
        db.create_index(u'purple_robot_app_purplerobotreading', ['size'])


    def backwards(self, orm):
        # Removing index on 'PurpleRobotReading', fields ['size']
        db.delete_index(u'purple_robot_app_purplerobotreading', ['size'])
