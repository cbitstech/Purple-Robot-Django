...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurpleRobotAlert.dismissed'
        db.add_column(u'purple_robot_app_purplerobotalert', 'dismissed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurpleRobotAlert.dismissed'
        db.delete_column(u'purple_robot_app_purplerobotalert', 'dismissed')
