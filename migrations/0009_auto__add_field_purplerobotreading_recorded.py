...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurpleRobotReading.recorded'
        db.add_column(u'purple_robot_app_purplerobotreading', 'recorded',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurpleRobotReading.recorded'
        db.delete_column(u'purple_robot_app_purplerobotreading', 'recorded')
    ...
    models = {
        ...
        u'purple_robot_app.purplerobotreading': {
            ...
            'recorded': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'user_id': ('django.db.models.fields.CharField', [], {'max_length': '1024'})
        },
