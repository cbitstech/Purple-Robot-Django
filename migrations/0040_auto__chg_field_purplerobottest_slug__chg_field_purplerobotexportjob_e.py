...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PurpleRobotTest.slug'
        db.alter_column(u'purple_robot_app_purplerobottest', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=1024))

        # Changing field 'PurpleRobotExportJob.end_date'
        db.alter_column(u'purple_robot_app_purplerobotexportjob', 'end_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'PurpleRobotExportJob.start_date'
        db.alter_column(u'purple_robot_app_purplerobotexportjob', 'start_date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'PurpleRobotTest.slug'
        db.alter_column(u'purple_robot_app_purplerobottest', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))

        # Changing field 'PurpleRobotExportJob.end_date'
        db.alter_column(u'purple_robot_app_purplerobotexportjob', 'end_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'PurpleRobotExportJob.start_date'
        db.alter_column(u'purple_robot_app_purplerobotexportjob', 'start_date', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        u'purple_robot_app.purplerobotdevice': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_reading_timestamp': ('django.db.models.fields.BigIntegerField', [], {'default': '0'}),
