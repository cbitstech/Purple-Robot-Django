...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurpleRobotDevice.test_device'
        db.add_column(u'purple_robot_app_purplerobotdevice', 'test_device',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurpleRobotDevice.test_device'
        db.delete_column(u'purple_robot_app_purplerobotdevice', 'test_device')
