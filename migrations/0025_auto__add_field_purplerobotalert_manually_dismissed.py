...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurpleRobotAlert.manually_dismissed'
        db.add_column(u'purple_robot_app_purplerobotalert', 'manually_dismissed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurpleRobotAlert.manually_dismissed'
        db.delete_column(u'purple_robot_app_purplerobotalert', 'manually_dismissed')
