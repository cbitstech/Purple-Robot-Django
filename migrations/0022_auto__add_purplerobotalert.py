...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PurpleRobotAlert'
        db.create_table(u'purple_robot_app_purplerobotalert', (
            ...
            ('action_url', self.gf('django.db.models.fields.URLField')(max_length=1024, null=True, blank=True)),
            ('probe', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
            ('user_id', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
            ('generated', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'purple_robot_app', ['PurpleRobotAlert'])


    def backwards(self, orm):
        # Deleting model 'PurpleRobotAlert'
        db.delete_table(u'purple_robot_app_purplerobotalert')
