...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'purple_robot_app_purplerobotdevice', 'device_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=256))
    ...
    models = {
        ...
        u'purple_robot_app.purplerobotdevice': {
            ...
            'device_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '256'}),
